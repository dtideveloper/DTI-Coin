...
contract DTI is StandardToken {
    

    // public variables of the token

    string public constant name = "dti";
    ...
    bool preSalePhase1 = true;
    bool preSalePhase2 = false;
    bool preSalePhase3 = false;
    ...
    function DTI() public {
        totalSupply = 1500000000e18;
        mainWallet = msg.sender;
        balances[mainWallet] = 60000000e18;
  ...
  function transferOwnership(address newOwner) onlyOwner public {
    ...
    function phaseLevelUp() onlyMainWallet returns (bool){
        if(phaseCount == 1){
            preSalePhase1 = false;
            preSalePhase2 = true;
            phaseCount = 2;
            balances[mainWallet] = 80000000e18;
            return true;
        }
    ...
    function endPreSale() onlyMainWallet returns (bool){
        phaseCount = 4;
        balances[mainWallet] = 1300000000e18;
        return true;
    }
